...
public class VideoChatActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ethis.mChatEditText = (EditText) findViewById(R.id.chat_input);
        ...
        localRender = VideoRendererGui.create(50, 50, 50, 50, VideoRendererGui.ScalingType.SCALE_ASPECT_FILL, true);
        ...
        this.pnRTCClient.listenOn("testchannel");
